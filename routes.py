...
async def generate_user_quotations(user_id: str, max_quotations: int = Query(None, description="Maximum number of quotations to generate"), user: dict = Depends(get_current_user)):
    try:
        inventory = db_manager.get_user_inventory(user_id)
